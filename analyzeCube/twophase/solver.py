...
import analyzeCube.twophase.coord as coord
from analyzeCube.twophase.enums import Move
import analyzeCube.twophase.moves as mv
import analyzeCube.twophase.pruning as pr
import time
from analyzeCube.twophase.defs import N_MOVE
...
def solve(cubestring, max_length=0, timeout=3):
...
def solveto(cubestring, goalstring, max_length=0, timeout=3):
