...
from analyzeCube.twophase.defs import cornerFacelet, edgeFacelet, cornerColor, edgeColor, N_SYM
from analyzeCube.twophase.enums import Color, Corner as Co, Edge as Ed
import analyzeCube.twophase.face
from analyzeCube.twophase.misc import c_nk, rotate_left, rotate_right
...
class CubieCube:
    ...
    def symmetries(self):
        ...
        from analyzeCube.twophase.symmetries import symCube, inv_idx  # not nice here but else we have circular imports
        s = []
        d = CubieCube()
