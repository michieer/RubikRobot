...
# Local imports for 3x3x3 cube color resolution
from analyzeCube.colorresolver.color import LabColor, html_color, lab_distance, rgb2lab
from analyzeCube.colorresolver.cube import RubiksCube
from analyzeCube.colorresolver.permutations import odd_cube_center_color_permutations
from analyzeCube.colorresolver.square import Square
from analyzeCube.colorresolver.tsp_solver_greedy import solve_tsp
from analyzeCube.colorresolver.cube_333 import corner_tuples, edge_orbit_id, center_groups

# Crayola color reference for 3x3x3 cubes
crayola_colors = {
    "Wh": LabColor(95.3, -2.4, 1.0, 255, 255, 255),
    "Ye": LabColor(97.1, -15.2, 93.2, 255, 255, 0),
    "OR": LabColor(74.9, 30.1, 69.0, 255, 153, 0),
    "Rd": LabColor(54.2, 80.1, 69.2, 204, 51, 0),
    "Gr": LabColor(50.3, -62.4, 52.0, 0, 102, 0),
    "Bu": LabColor(32.3, 79.2, -107.9, 0, 0, 153),
}
...
class RubiksColorSolverGeneric(RubiksCube):
    ...
    def set_state(self) -> None:
        ...
        # For 3x3x3 cubes, use odd cube center color permutations
        min_distance = None
    ...
    def cube_for_json(self):
        ...
        data["html"] = self.html_cube("Final Cube", True, "final_cube")
        return data
    ...
    def assign_color_names(
        ...
        if color_permutations == "odd_cube_center_color_permutations":
            for permutation in odd_cube_center_color_permutations:
                distance = (
    ...
    def resolve_color_box(self) -> None:
        ...
        # For 3x3x3 cubes, use the dead center squares to define the color box
    ...
    def resolve_corner_squares(self) -> None:
        ...
        from analyzeCube.colorresolver.cube_333 import corner_tuples
    ...
    def resolve_edge_squares(self) -> None:
        ...
        """
        # rubiks cube libraries
        from analyzeCube.colorresolver.cube_333 import edge_orbit_id
    ...
    def resolve_center_squares(self) -> None:
        ...
        """
        # rubiks cube libraries
        from analyzeCube.colorresolver.cube_333 import center_groups
...
def resolve_colors(rgb=None, use_json=False, filename=None, argv=None):
    ...
    # For 3x3x3 cubes only
    if width != 3:
        raise ValueError("This solver only supports 3x3x3 cubes")
    ...
    if use_json:
        # return JSON-serializable object for programmatic use
        from json import dumps as json_dumps

        result = json_dumps(cube.cube_for_json(), indent=4, sort_keys=True)
    else:
        # print human-friendly cube and return kociemba string
        cube.print_cube()
